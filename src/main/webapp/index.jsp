...
<body>
    <div class="container">
        <div class="content">
            <h1>Hello ... ! <span class="name">Devops Enthusiast !</span></h1>
            <p>My name is <span class="highlighted-name">anaswara</span>, I am an <span class="trainer">AWS and DevOps Engineer</span>.</p>
